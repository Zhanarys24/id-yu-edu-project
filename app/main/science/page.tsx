...
function EduCard({
  ...
  return (
    <div className="bg-white rounded-lg px-5 py-4 shadow-sm flex flex-col justify-between h-52 w-full max-w-full sm:max-w-[290px] lg:max-w-[340px] overflow-hidden transition-transform">
