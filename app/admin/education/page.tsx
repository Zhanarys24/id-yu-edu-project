              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 mt-1">
                    Управление карточками образования, науки и воспитания
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="flex flex-col lg:flex-row gap-4">
            <div className="flex-1">
              <label className="block text-sm font-semibold text-gray-800 mb-2">
                Поиск карточек в разделе "{categoryInfo.title}"
              </label>
        ...
        {filteredCards.length === 0 && (
          <Card className="p-16 text-center bg-white/80 backdrop-blur-sm border-0 shadow-lg">
            <div className="p-8 bg-gradient-to-br from-purple-50 to-indigo-50 rounded-3xl">
              {categoryInfo.icon}
              <h3 className="text-2xl font-bold text-gray-900 mb-3 mt-4">Нет карточек</h3>
              <p className="text-gray-600 text-lg">В разделе "{categoryInfo.title}" пока нет карточек</p>
            </div>
          </Card>
        )}
